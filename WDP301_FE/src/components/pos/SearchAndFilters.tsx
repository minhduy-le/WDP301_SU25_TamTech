    ...
    <div className="space-y-4">
      ...
      <div className="flex items-center space-x-3">
        ...
        <button
          ...
          className={`flex items-center space-x-2 px-4 py-2 rounded-lg border outline-none transition-colors font-medium
              ...
              <button
                ...
                className={`p-3 rounded-lg font-medium transition-colors border text-center ${
                  priceFilter === filter.id
                    ? "bg-amber-100 text-amber-800 border-amber-300 focus:ring-2 focus:ring-amber-300 focus:border-amber-200 focus:outline-none hover:border-amber-400"
                    : "bg-amber-50 text-amber-600 border-amber-200 focus:ring-2 focus:ring-amber-300 focus:border-amber-200 focus:outline-none hover:bg-amber-100 hover:border-amber-400"
                }`}
              >
