      ...
      if (existingChat) {
        createChatMutation.mutate(
          ...
          },
          {
            ...
            onError: (error) => message.error(error.message || "Gửi tin nhắn thất bại!"),
          }
        );
      } else {
        createChatMutation.mutate(
          ...
          <>
            ...
            >
              {isChatsLoading ? (
                ...
                userChats.map((chat) => (
                  ...
                  >
                    ...
                    >
                      <small
                        style={{
                          color: chat.senderId === authUser?.id ? "white" : "black",
                          fontSize: "12px",
                        }}
                      >
                ...
                <p style={{ textAlign: "center", color: "#888" }}>Chưa có tin nhắn với người này.</p>
              )}
            </div>
            <div
              style={{
