      ...
      >
        <div className="modal-content">
          ...
          <div className="modal-add-ons">
            ...
            <div className="add-on-item">
              <Checkbox
                checked={selectedAddOns.comThem}
                onChange={(e) => handleAddOnChange("comThem", e.target.checked)}
              >
            ...
            <div className="add-on-item">
              <Checkbox
                checked={selectedAddOns.chaTrungHap}
                onChange={(e) =>
                  handleAddOnChange("chaTrungHap", e.target.checked)
                }
              >
            ...
            <div className="add-on-item">
              <Checkbox
                checked={selectedAddOns.suonNuong}
                onChange={(e) =>
                  handleAddOnChange("suonNuong", e.target.checked)
                }
              >
